...
insert into documento(contacto_destino,direccion,distrito_id,documento_autogenerado,nro_documento,razon_social_destino,referencia,telefono,envio_id) values('CONTACTO 1','DIRECCION 1',1,'A00001',1,'RAZON SOCIAL 1','','',1)
insert into documento(contacto_destino,direccion,distrito_id,documento_autogenerado,nro_documento,razon_social_destino,referencia,telefono,envio_id) values('CONTACTO 2','DIRECCION 2',1,'A00002',1,'RAZON SOCIAL 2','','',1)
insert into documento(contacto_destino,direccion,distrito_id,documento_autogenerado,nro_documento,razon_social_destino,referencia,telefono,envio_id) values('CONTACTO 3','DIRECCION 3',1,'A00003',1,'RAZON SOCIAL 3','','',1)
insert into documento(contacto_destino,direccion,distrito_id,documento_autogenerado,nro_documento,razon_social_destino,referencia,telefono,envio_id) values('CONTACTO 4','DIRECCION 4',1,'A00004',1,'RAZON SOCIAL 4','','',2)
insert into documento(contacto_destino,direccion,distrito_id,documento_autogenerado,nro_documento,razon_social_destino,referencia,telefono,envio_id) values('CONTACTO 5','DIRECCION 5',1,'A00005',1,'RAZON SOCIAL 5','','',3)
insert into documento(contacto_destino,direccion,distrito_id,documento_autogenerado,nro_documento,razon_social_destino,referencia,telefono,envio_id) values('CONTACTO 6','DIRECCION 6',1,'A00006',1,'RAZON SOCIAL 6','','',3)
insert into documento(contacto_destino,direccion,distrito_id,documento_autogenerado,nro_documento,razon_social_destino,referencia,telefono,envio_id) values('CONTACTO 7','DIRECCION 7',1,'A00007',1,'RAZON SOCIAL 7','','',3)
insert into documento(contacto_destino,direccion,distrito_id,documento_autogenerado,nro_documento,razon_social_destino,referencia,telefono,envio_id) values('CONTACTO 8','DIRECCION 8',1,'A00008',1,'RAZON SOCIAL 8','','',3)
insert into documento(contacto_destino,direccion,distrito_id,documento_autogenerado,nro_documento,razon_social_destino,referencia,telefono,envio_id) values('CONTACTO 9','DIRECCION 9',1,'A00009',1,'RAZON SOCIAL 9','','',4)
insert into documento(contacto_destino,direccion,distrito_id,documento_autogenerado,nro_documento,razon_social_destino,referencia,telefono,envio_id) values('CONTACTO 10','DIRECCION 10',1,'A00010',1,'RAZON SOCIAL 10','','',5)
...
insert into guia(numero_guia,plazo_distribucion_id,proveedor_id,tipo_seguiridad_id,tipo_servicio_id) values('G0001',1,2,1,1)
...
insert into documento_guia(documento_id,guia_id,fecha_asociacion,validado) values(5,1,getdate(),0)
insert into documento_guia(documento_id,guia_id,fecha_asociacion,validado) values(6,1,getdate(),0)
insert into documento_guia(documento_id,guia_id,fecha_asociacion,validado) values(7,1,getdate(),0)
insert into documento_guia(documento_id,guia_id,fecha_asociacion,validado) values(8,1,getdate(),0)
insert into documento_guia(documento_id,guia_id,fecha_asociacion,validado) values(4,2,getdate(),0)
insert into documento_guia(documento_id,guia_id,fecha_asociacion,validado) values(9,2,getdate(),0)
insert into documento_guia(documento_id,guia_id,fecha_asociacion,validado) values(10,2,getdate(),0)
